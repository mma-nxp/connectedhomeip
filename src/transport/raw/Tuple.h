...
public:
    ...
    CHIP_ERROR Init(TransportMessageHandler * owner, Args &&... args)
    {
...
private:
    ...
    CHIP_ERROR InitImpl(TransportMessageHandler * owner, InitArg && arg, Rest &&... rest)
    {
     ...
     */
    CHIP_ERROR InitImpl(TransportMessageHandler * owner) { return CHIP_NO_ERROR; }
